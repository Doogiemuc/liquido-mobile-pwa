<template>
	<div class="box law-panel">
		<div class="media">
			<div class="media-left">
				<figure class="image">
					<img :src="law.createdBy.profile.picture" alt="avatar" class="avatar">
				</figure>
			</div>
			<div class="media-content">
				<div class="content law-panel-content">
					<h2>{{law.title}}</h2>
					<div class="author" >&ndash;{{law.createdBy.profile.name}} <span :class="{'supported': law.supportedByCurrentUser}"><b-icon pack="fas" icon="thumbs-up" size="is-small"></b-icon>{{law.numSupporters}}</span></div>
...
//TODO: like button - maybe as .avatar:hover { ... }
